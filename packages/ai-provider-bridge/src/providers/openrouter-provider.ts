...
import { getAnthropicModelCapabilities, normalizeOpenRouterBaseUrl } from "ai-config";
...
const openRouterClientFactory: ClientFactory = (credentials) => {
...
export function registerCustomOpenRouterProvider(
